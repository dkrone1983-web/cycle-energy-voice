...
@Composable
fun ConfirmCheckInScreen(navController: NavHostController) {
    ...
    if (saveSuccess.value) {
        navController.navigate(Screen.Home.route) {
            popUpTo(Screen.ConfirmCheckIn.route) { inclusive = true }
        }
    }
                ...
                Row(
                    ...
                    CyclePhase.values().filter { it != CyclePhase.UNKNOWN }.forEach { phase ->
                        FilterChip(
                            ...
                            label = { Text(phase.displayName, style = MaterialTheme.typography.labelSmall) }
                        )
                    }
                }
            }
                ...
                Row(
                    ...
                    TimeOfDay.values().filter { it != TimeOfDay.UNKNOWN }.forEach { time ->
                        FilterChip(
                            ...
                            label = { Text(time.displayName, style = MaterialTheme.typography.labelSmall) }
                        )
                    }
                }
            }
